export const PRICING_PACKAGES = [
  ...
  },
  {
    ...
    description: [
      ...
      "A real person watches, listens to, or reads the work. You get a 10+ sentence review.",
  ...
  },
  {
    ...
    description: [
      ...
      "Same human + AI review as the $5 tier, including the 10+ sentence review.",
...
export const PRICING_PROMISE = {
  ...
  lines: [
    "FREE = AI opinions. 5 every day. 6 sentences or less. No share switch.",
    "HUMAN + AI = 5 credits. Use them when you want. 10+ sentence review. Share on or off at Submit.",
    "HUMAN + AI PRO = 10 credits. Use them when you want. 10+ sentence review. Private. Your opinion is not shared.",
